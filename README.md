...
```
$ git clone git@github.com:ABfinance-exchange/usa-docs.git  # clone the repo
```
...
Running the below script copies our custom js files into an untracked lib directory, which enables sending authenticated requests to the API.
