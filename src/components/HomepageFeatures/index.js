...
const FeatureList = [
  {
    ...
    description: (
      <>
        Abfinance's latest v1 suite of APIs allow for a smooth and easy integration.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        <b>Learn</b> the intricate details of market rules to fully maximise your API usage.
      </>
    ),
  },
  {
