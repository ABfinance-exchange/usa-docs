...
You can query configuration by [Get Trade Behaviour Setting](/usa-docs/v5/account/get-user-setting-config#).
...
Corresponding to <a href="https://abfinance-exchange.github.io/usa-docs/v5/account/get-user-setting-config">Get Limit Price Behaviour</a> that **lpaSpot = false**
