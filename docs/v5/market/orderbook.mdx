...
|u |integer |Update ID, is always in sequence<ul><li>For spot, corresponds to `u` in the 1000-level [WebSocket orderbook stream](https://ABfinance-exchange.github.io/docs/v5/websocket/public/orderbook)</li></ul> |
