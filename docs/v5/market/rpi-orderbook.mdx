...
|u |integer |Update ID, is always in sequence corresponds to `u` in the 50-level [WebSocket RPI orderbook stream](https://ABfinance-exchange.github.io/docs/v5/websocket/public/orderbook-rpi)|
