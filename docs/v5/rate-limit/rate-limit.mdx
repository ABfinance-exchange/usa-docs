...
<table border="0.8">
    ...
    <tr>
        <td rowSpan="8">POST</td><td>/v5/order/create</td><td align="center">20/s</td><td align="center">Y</td>
    </tr>
    <tr>
        <td>/v5/order/amend</td><td align="center">10/s</td><td align="center">Y</td>
    </tr>
    <tr>
        <td>/v5/order/cancel</td><td align="center">20/s</td><td align="center">Y</td>
    </tr>
    <tr>
        <td>/v5/order/cancel-all</td><td align="center">20/s</td><td align="center">Y</td>
    </tr>
    <tr>
        <td>/v5/order/create-batch</td><td align="center">20/s</td><td align="center">Y</td>
    </tr>
    <tr>
        <td>/v5/order/amend-batch</td><td align="center">20/s</td><td align="center">Y</td>
    </tr>
    <tr>
        <td>/v5/order/cancel-batch</td><td align="center">20/s</td><td align="center">Y</td>
    </tr>
    <tr>
        <td>/v5/order/disconnected-cancel-all</td><td align="center">5/s</td><td align="center">N</td>
    </tr>
    <tr>
        <td rowSpan="4">GET</td><td>/v5/order/realtime</td><td align="center">50/s</td><td align="center">N</td>
    </tr>
    <tr>
        <td>/v5/order/history</td><td align="center">50/s</td><td align="center">N</td>
    </tr>
    <tr>
        <td>/v5/execution/list</td><td align="center">50/s</td><td align="center">N</td>
    </tr>
    <tr>
        <td>/v5/order/spot-borrow-check</td><td align="center">50/s</td><td align="center">N</td>
    </tr>
</table>
</span>
...
<table border="0.8">
    ...
    <tr>
        <td rowSpan="12">GET</td><td>/v5/account/wallet-balance</td><td>accountType=UNIFIED</td><td>50/s</td><td align="center">N</td>
    </tr>
    <tr>
    ...
    <tr>
        <td>/v5/account/fee-rate</td><td></td><td>50/s</td><td align="center">N</td>
    </tr>
</table>
</span>
