...
|> [bizType](/usa-docs/v5/enum#biztype) |**true**|string|Business type |
...
|> [bizType](/usa-docs/v5/enum#biztype) |string|Business type |
|> rate |integer|API rate limit per second |
|> success |boolean| Whether or not the request was successful|
|> [msg](/usa-docs/v5/enum#msg) |string|Result message |
