...
|:----- |:-------|:-----|------ |
|category|**true**|string|`OnChain`<br/>**Remarks**: currently, only on chain is supported|
...
```http
GET /v5/earn/product?category=OnChain&coin=BTC HTTP/1.1
