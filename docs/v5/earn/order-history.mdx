...
|:----- |:-------|:-----|------ |
|category|**true**|string|`OnChain` <br/>**Remarks**: currently, only OnChain is supported|
|orderId|false|string|Order ID.  <li>For category = `OnChain`, either orderId or orderLinkId is **required**</li><li>if both are passed, make sure they're matched, otherwise returning empty result</li>|
