...
* All-In-One topic: Allow you to listen to all categories (spot) websocket updates
...
|> execFee |string |Executed trading fee. You can get spot fee currency instruction [here](../../enum#spot-fee-currency-instruction)<br/>|
...
|> extraFees |List |Extra trading fee information. Enum: [feeType](../../enum#extrafeesfeetype), [subFeeType](../../enum#extrafeessubfeetype)
