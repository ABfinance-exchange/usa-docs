...
:::info
[Retail Price Improvement (RPI)](https://www.abfinance.com/en/help-center/article/Retail-Price-Improvement-RPI-Order) orders will not be included in the messages.
:::
...
See working code examples of this logic in the [FAQ](https://ABfinance-exchange.github.io/docs/faq#how-can-i-process-websocket-snapshot-and-delta-messages).

:::info
- Spot level 1 data: if 3 seconds have elapsed without a change in the orderbook, a `snapshot` message will be pushed again, and the field `u` will be the 
