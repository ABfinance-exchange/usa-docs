...
- **Mainnet:**<br/>
Spot: `wss://stream.abfinance.com/v1/public/spot`<br/>

- **Testnet:**<br/>
Spot: `wss://stream-testnet.abfinance.com/v1/public/spot`<br/>

**[WebSocket private stream](../websocket/private/order#):**
- **Mainnet:**<br/>
`wss://stream.abfinance.com/v1/private`

- **Testnet:**<br/>
`wss://stream-testnet.abfinance.com/v1/private`
