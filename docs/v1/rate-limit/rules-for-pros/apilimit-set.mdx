...
|> [bizType](/usa-docs/v1/enum#biztype) |**true**|string|Business type |
...
|> [bizType](/usa-docs/v1/enum#biztype) |string|Business type |
|> rate |integer|API rate limit per second |
|> success |boolean| Whether or not the request was successful|
|> [msg](/usa-docs/v1/enum#msg) |string|Result message |

### Request Example
```http
POST /v1/apilimit/set HTTP/1.1
