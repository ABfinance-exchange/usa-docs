...
|u |integer |Update ID, is always in sequence<ul><li>For spot, corresponds to `u` in the 1000-level [WebSocket orderbook stream](https://ABfinance-exchange.github.io/docs/v1/websocket/public/orderbook)</li></ul> |
...
```http
GET /v1/market/orderbook?category=spot&symbol=BTCUSDT HTTP/1.1
