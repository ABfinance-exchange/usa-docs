...
## How to set SMP?
Check request params of [Place Order](/v1/order/create-order). Specify parameter `smpType` when placing the order
...
You can contact your institutional business manager or email the exchange via: institutional_services@abfinance.com
