...
### HTTP Request
GET `/v1/asset/deposit/query-sub-member-record`
...
|> taxDepositRecordsId|string|declare tax id|
|> taxStatus|integer|<li>0: No reporting required</li><li>1: Reporting pending</li><li>2: Reporting completed</li>|
...
```http
GET /v1/asset/deposit/query-sub-member-record?coin=USDT&limit=1&subMemberId=592334 HTTP/1.1
