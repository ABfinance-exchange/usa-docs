...
### HTTP Request
GET `/v1/asset/transfer/query-universal-transfer-list`
...
```http
GET /v1/asset/transfer/query-universal-transfer-list?limit=1&cursor=eyJtaW5JRCI6MTc5NjU3OCwibWF4SUQiOjE3OTY1Nzh9 HTTP/1.1
