...
### HTTP Request
GET `/v1/asset/exchange/convert-result-query`

### Request Parameters
| Parameter | Required | Type | Comments|
|:----- |:-------|:-----|------ |
|quoteTxId |**true** |string |Quote tx ID|
|[accountType](/v1/enum#convertaccounttype) |**true** |string |Wallet type|
...
```http
GET /v1/asset/exchange/convert-result-query?quoteTxId=10100108106409343501030232064&accountType=eb_convert_funding HTTP/1.1
