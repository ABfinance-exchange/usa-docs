...
### HTTP Request
GET `/v1/asset/exchange/query-coin-list`

### Request Parameters
| Parameter | Required | Type | Comments|
|:----- |:-------|:-----|------ |
|[accountType](/v1/enum#convertaccounttype) |**true** |string |Wallet type <li>`eb_convert_funding`</li><li>`eb_convert_uta`</li><li>`eb_convert_spot`</li>|
...
```http
GET /v1/asset/exchange/query-coin-list?side=0&accountType=eb_convert_funding HTTP/1.1
