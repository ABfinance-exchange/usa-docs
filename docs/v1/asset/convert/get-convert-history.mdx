...
### HTTP Request
GET `/v1/asset/exchange/query-convert-history`

### Request Parameters
| Parameter | Required | Type | Comments|
|:----- |:-------|:-----|------ |
|[accountType](/v1/enum#convertaccounttype) |false |string |Wallet type <li>Supports passing multiple types, separated by comma e.g., <code>eb_convert_funding,eb_convert_uta</code></li><li>Return all wallet types data if not passed</li>|
...
|> [accountType](/v1/enum#convertaccounttype) |string|Wallet type |
...
```http
GET /v1/asset/exchange/query-convert-history?accountType=eb_convert_uta,eb_convert_funding HTTP/1.1
