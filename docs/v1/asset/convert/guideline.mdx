...
|:----|:----:|----|----|
|GET |/v1/asset/exchange/query-coin-list | 100 req/s| N |
|POST |/v1/asset/exchange/quote-apply | 50 req/s| N |
|POST |/v1/asset/exchange/convert-execute | 50 req/s| N |
|GET |/v1/asset/exchange/convert-result-query | 100 req/s| N |
|GET |/v1/asset/exchange/query-convert-history| 100 req/s| N |
</span>
