...
### HTTP Request
GET `/v1/asset/withdraw/vasp/list`
...
|> vaspEntityId |string |Receiver platform id. When transfer to exchange or other exchanges that not in the list, please use vaspEntityId='others'|
...
```http
GET /v1/asset/withdraw/vasp/list HTTP/1.1
