...
### HTTP Request
GET `/v1/asset/withdraw/query-record`
...
|> toAddress |string |To withdrawal address. Shows the exchange UID for internal transfers |
|> tag |string |Tag |
...
```http
GET /v1/asset/withdraw/query-record?coin=USDT&withdrawType=2&limit=2 HTTP/1.1
