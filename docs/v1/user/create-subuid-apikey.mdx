...
|> Derivatives |false |array |**Deprecated** because system will automatically add this permission|
|> CopyTrading |false |array |Copytrade. `["CopyTrading"]` **deprecated** because using signal copy trading now|
...
```http
POST /v1/user/create-sub-api HTTP/1.1
