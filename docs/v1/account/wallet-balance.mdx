...
|> accountIMRate |string |Account IM rate <li>All account wide fields are <b>not</b> applicable to isolated margin</li>|
...
```http
GET /v1/account/wallet-balance?accountType=UNIFIED&coin=BTC HTTP/1.1
