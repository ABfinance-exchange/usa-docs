...
* All-In-One topic: 允許您監聽所有業務線的websocket更新(現貨)
...
|data |array |Object |
|> [category](../../enum#category) | string | 產品類型 `spot`|
|> symbol |string |合約名稱|
...
|> extraFees |List |交易費率。字段枚舉: [feeType](../../enum#extrafeesfeetype), [subFeeType](../../enum#extrafeessubfeetype)
