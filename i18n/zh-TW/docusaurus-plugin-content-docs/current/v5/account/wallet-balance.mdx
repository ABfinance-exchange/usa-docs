...
:::info
* 在UTA手動借貸新邏輯下，現貨負債對應的`spotBorrow`
...
|> accountIMRate |string |帳戶初始保證金率 <li>您可以參考該[鏈結](https://www.abfinance.com/en/help-center/article/Glossary-Unified-Trading-Account)了解統一帳戶下字段含義和計算方式</li><li>下面所有帳戶維度的字段都不適用於逐倉模式</li>|
